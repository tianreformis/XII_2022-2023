...
_0x0:
	.DB  0x4B,0x65,0x6C,0x61,0x73,0x20,0x58,0x49
	.DB  0x49,0x20,0x49,0x50,0x41,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0031 // Function: Bit7=Out Bit6=Out Bit5=Out Bit4=Out Bit3=In Bit2=Out Bit1=Out Bit0=Out
; 0000 0032 DDRC=(1<<DDC7) | (1<<DDC6) | (1<<DDC5) | (1<<DDC4) | (0<<DDC3) | (1<<DDC2) | (1<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(247)
	OUT  0x14,R30
; 0000 0033 // State: Bit7=1 Bit6=1 Bit5=1 Bit4=1 Bit3=T Bit2=1 Bit1=1 Bit0=1
; 0000 0034 PORTC=(1<<PORTC7) | (1<<PORTC6) | (1<<PORTC5) | (1<<PORTC4) | (0<<PORTC3) | (1<<PORTC2) | (1<<PORTC1) | (1<<PORTC0);
	OUT  0x15,R30
; 0000 0035 
...
; 0000 009A lcd_gotoxy(1,0);
	LDI  R30,LOW(1)
	ST   -Y,R30
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 009B lcd_putsf("Kelas XII IPA");
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
