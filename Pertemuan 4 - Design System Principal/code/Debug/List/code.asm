...
; 0000 0032 PORTD=(1<<PORTD7) | (1<<PORTD6) | (1<<PORTD5) | (1<<PORTD4) | (1<<PORTD3) | (1<<PORTD2) | (1<<PORTD1) | (1<<PORTD0);
	OUT  0x12,R30
; 0000 0033 
...
; 0000 007F PORTD=0b10000000;
	LDI  R30,LOW(128)
	RCALL SUBOPT_0x0
; 0000 0080 delay_ms(100);
; 0000 0081 PORTD=0b01000000;
	LDI  R30,LOW(64)
	RCALL SUBOPT_0x0
; 0000 0082 delay_ms(100);
; 0000 0083 PORTD=0b00100000;
	LDI  R30,LOW(32)
	RCALL SUBOPT_0x0
; 0000 0084 delay_ms(100);
; 0000 0085 PORTD=0b00010000;
	LDI  R30,LOW(16)
	RCALL SUBOPT_0x0
; 0000 0086 delay_ms(100);
; 0000 0087 PORTD=0b00001000;
	LDI  R30,LOW(8)
	RCALL SUBOPT_0x0
; 0000 0088 delay_ms(100);
; 0000 0089 PORTD=0b00000100;
	LDI  R30,LOW(4)
	RCALL SUBOPT_0x0
; 0000 008A delay_ms(100);
; 0000 008B PORTD=0b00000010;
	LDI  R30,LOW(2)
	RCALL SUBOPT_0x0
; 0000 008C delay_ms(100);
; 0000 008D PORTD=0b00000001;
	LDI  R30,LOW(1)
	RCALL SUBOPT_0x0
